...
{
    public partial class frmYXSLHLBBase : Form
    {
        ...
        public frmYXSLHLBBase()
        {
            InitializeComponent();
            ds = db.GetDataSet("SELECT Fdbstr  FROM dbo.YXZTLIST WHERE ID=8", "con");
        ...
        {
            string sSQL = string.Empty;
            sSQL = " select *  FROM  t_YXSLHLBBase b ";
            sSQL += " Where 1=1 ";
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //string sFDate = dttSQL.Rows[0]["FName"].ToString().Trim();
            //string sFExpression = dttSQL.Rows[0]["FExpression"].ToString().Trim();
            ...
            if (MasterState == "ADD")
            {
                sSQL = " SELECT count(*) from t_YXSLHLBBase where FInterID=@FInterID   ";
            ...
            if (MasterState == "ADD")
            {
                sSQL = " insert into t_YXSLHLBBase(FInterID, FDate,FExpression,FNumber,FName) values (@FInterID, @FDate,@FExpression,@FNumber,@FName) ";
                SqlParameter[] par = new SqlParameter[] 
								{
								   new SqlParameter("@FInterID", sFItemID),
								   new SqlParameter("@FDate",dtFdate.Text.Trim()),
									 new SqlParameter("@FExpression",txtFExpression.Text.Trim()),
            ...
            else if (MasterState == "EDIT")
            {
                ...
                sSQL = " delete from t_YXSLHLBBase where FInterID=@FInterID";
        ...
        {
            string sSQL = string.Empty;
            sSQL = " SELECT * from t_YXSLHLBBase ";
            ...
            if (dttSQL.Rows.Count > 0)
            {
                ...
                dtFdate.Text = dttSQL.Rows[0]["FDate"].ToString();
                txtFExpression.Text = dttSQL.Rows[0]["FExpression"].ToString();
            }
            else
            {
                ...
                txtFName.Text = string.Empty;
                txtFNumber.Text = string.Empty;
                dtFdate.Text = string.Empty;
                txtFExpression.Text = string.Empty;
        ...
        private void SetTextBoxState(string sMasterState)
        {
            ...
            if (sMasterState == "SEL")
            {
                ...
                dtFdate.Enabled = false;
                txtFExpression.ReadOnly = true;
            ...
            else if (sMasterState == "ADD")
            {
                ...
                dtFdate.Enabled = true;
                txtFExpression.ReadOnly = false;
