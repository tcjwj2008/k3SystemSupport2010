...
namespace YXK3FZ.RP.from
{
    public partial class frmBTpfsk : Form
    {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
                    ...
                    strCondition += " SUM(ISNULL(头数3,0))+SUM(ISNULL(头数4,0))+SUM(ISNULL(头数5,0)) 头数3,SUM(ISNULL(重量3,0))+SUM(ISNULL(重量4,0))+SUM(ISNULL(重量5,0))重量3,SUM(ISNULL(金额3,0))+SUM(ISNULL(金额4,0))+SUM(ISNULL(金额5,0))金额3, ";
