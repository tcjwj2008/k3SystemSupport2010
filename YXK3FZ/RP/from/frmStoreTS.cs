...
{
    public partial class frmStoreTS : Form
    {
        ...
        private void frmStoreTS_Load(object sender, EventArgs e)
        {
            //sp_sel_StoreCount_New_qiu
            ...
            try
            {
                ds = db.GetProcDataSet("sp_sel_StoreCount_New_qiu", inputParameters);
