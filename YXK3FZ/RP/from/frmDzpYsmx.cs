...
{
    public partial class frmDzpYsmx : Form
    {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
          //MessageBox.Show("shuangji");
            ...
            SqlParameter[] inputParameters = parameters.ToArray();
						...
						if (DB_ID == 4 && Convert.ToInt32(this.txtYear.Text.Trim()) == 2018 && Convert.ToInt32(this.txtMonth.Text.Trim()) == 1)
						{
							dt = k3db.GetDataTable("sp_DzpYsTJ_one_ts201801", inputParameters);
						}
						else
						{
							dt = k3db.GetDataTable("sp_DzpYsTJ_one", inputParameters);
						}
