...
{
    public partial class frmDzpYsmx_test : Form
    {
        DataBase db = new DataBase();
        DataBase k3db = null;
        DataSet ds = null;
        CommonUse commUse = new CommonUse();
        public List<String> Fcu = new List<string>();
        public frmDzpYsmx_test()
        {
            InitializeComponent();
        }

        private int _DB_ID = 4;
        public int DB_ID
        {
            get { return _DB_ID; }
            set { _DB_ID = value; }
        ...
        int page = 0;
        private void frmDzpYsmx_test_Load(object sender, EventArgs e)
        {
        ...
        private void btnSelect_Click(object sender, EventArgs e)
        {
            ...
            //sql.Add(" TRUNCATE TABLE dbo.t_Fcu  ");
            //foreach (string s in Fcu)
            //{
            //    sql.Add("INSERT dbo.t_Fcu( sdfcurnumber )VALUES  ( '" + s + "')");
            //}
            //string mes = k3db.ExecDataBySqls1(sql);
            // if (mes != "成功")
            // {
            //     MessageBox.Show(mes);
            //     return;
