...
{
    public partial class frmStoreWeight : Form
    {
        ...
        private void frmStoreWeight_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ds = db.GetProcDataSet("sp_sel_StoreWeight_qiu", inputParameters);
