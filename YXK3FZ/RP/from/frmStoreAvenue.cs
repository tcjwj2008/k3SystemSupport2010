...
{
    public partial class frmStoreAvenue : Form
    {
        ...
        private void frmStoreAvenue_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ds = db.GetProcDataSet("sp_sel_StoreAvenue_New_qiu", inputParameters);
