...
{
    public partial class frmDzpYsTJ : Form
    {
        ...
        private void frmDzpYsTJ_Load(object sender, EventArgs e)
        {//窗体加载
        ...
        {//select 
            ...
            try
            {
							...
							{
								dt = k3db.GetDataTable("sp_DzpYsTJ", inputParameters);
							}
        ...
        {//双击
            ...
            frmDzpYsmx.txtFcurnumber.Text = this.dataGridView1[1, e.RowIndex].Value.ToString();
            frmDzpYsmx.Show();
            }
