...
{
    public partial class frmMOrderList : Form
    {
        ...
        string vwname = "vw_yx_order";
				...
				public frmMOrderList(string Zttype)
        {
            InitializeComponent();
        ...
        private void tsbtnSel_Click(object sender, EventArgs e)
        {
            ...
            if (this.dgvOrderList.Rows.Count <= 0 || this.dgvOrderList.CurrentRow==null)
            {
                return;
						...
						frmMOrder frmOrder = new frmMOrder(this.ZtType, "SEL", this.dgvOrderList["Finterid", this.dgvOrderList.CurrentRow.Index].Value.ToString());
            frmOrder.Show();
