...
{
    public partial class frmROrderList : Form
    {
        ...
        string vwname = "vw_yx_order";
				...
				public frmROrderList(string Zttype)
        {
            InitializeComponent();
        ...
        private void tsbtnSel_Click(object sender, EventArgs e)
        {
            ...
            if (this.dgvOrderList.Rows.Count <= 0 || this.dgvOrderList.CurrentRow==null)
            {
                return;
						...
						frmROrder frmOrder = new frmROrder(this.ZtType, "SEL", this.dgvOrderList["Finterid", this.dgvOrderList.CurrentRow.Index].Value.ToString());
            frmOrder.Show();
