...
{
    public partial class frm_ry_orderMary : Form
    {
        ...
        private void btnSel_Click(object sender, EventArgs e)
        {
            ...
            param1.Value = this.cmbType.SelectedIndex + 1;

            SqlParameter param2 = new SqlParameter("@pdate", SqlDbType.VarChar);
            ...
            DataTable dt = k3db.GetDataTable("sp_yx_rybbPrint", inputParameters);
            string strReportPath = Application.StartupPath;

            strReportPath += @"\RPT\肉业订单打印.rpt";
