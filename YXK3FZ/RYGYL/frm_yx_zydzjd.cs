...
{
    public partial class frm_yx_zydzjd : Form
    {
        ...
        string conSp;
        public frm_yx_zydzjd()
        {
            InitializeComponent();
        }

        private void frm_yx_zydzjd_Load(object sender, EventArgs e)
        {
        ...
        private void btnSel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                dsbb = k3db.GetProcDataSet("sp_yx_Getzydzjdbb", inputParameters);
            }
            catch
            {
