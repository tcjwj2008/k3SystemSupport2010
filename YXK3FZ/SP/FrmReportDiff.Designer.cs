namespace YXK3FZ.SP
{
	partial class FrmReportDiff
	{
		...
		private void InitializeComponent()
		{
			...
			this.splitContainer1.Size = new System.Drawing.Size(1080, 569);
			...
			// Column5
			// 
			this.Column5.DataPropertyName = "级别";
			...
			// Column6
			// 
			this.Column6.DataPropertyName = "昨天头数";
			this.Column6.HeaderText = "昨天头数";
			this.Column6.Name = "Column6";
			this.Column6.ReadOnly = true;
			// 
			// Column9
			// 
			this.Column9.DataPropertyName = "昨天猪头";
			this.Column9.HeaderText = "昨天猪头";
			this.Column9.Name = "Column9";
			this.Column9.ReadOnly = true;
			// 
			// Column10
			// 
			this.Column10.DataPropertyName = "昨天备注";
			this.Column10.HeaderText = "昨天备注";
			...
			// Column11
			// 
			this.Column11.DataPropertyName = "今天头数";
			this.Column11.HeaderText = "今天头数";
			this.Column11.Name = "Column11";
			this.Column11.ReadOnly = true;
			// 
			// Column12
			// 
			this.Column12.DataPropertyName = "今天猪头";
			this.Column12.HeaderText = "今天猪头";
			this.Column12.Name = "Column12";
			this.Column12.ReadOnly = true;
			// 
			// Column13
			// 
			this.Column13.DataPropertyName = "今天备注";
			this.Column13.HeaderText = "今天备注";
