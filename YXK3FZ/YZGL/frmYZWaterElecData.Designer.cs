...
{
	partial class frmYZWaterElecData
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZWaterElecData));
			...
			this.edtFDate = new System.Windows.Forms.DateTimePicker();
			...
			this.cobFBoatIDQ = new System.Windows.Forms.ComboBox();
			...
			// 
			this.splitContainer1.Panel1.Controls.Add(this.edtFDate);
			...
			this.splitContainer1.Panel1.Controls.Add(this.cobFBoatID);
			...
			// edtFDate
			// 
			this.edtFDate.CustomFormat = "yyyy-MM-dd";
			this.edtFDate.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this.edtFDate.Location = new System.Drawing.Point(68, 10);
			this.edtFDate.Name = "edtFDate";
			this.edtFDate.Size = new System.Drawing.Size(272, 21);
			this.edtFDate.TabIndex = 45;
			// 
			// edtFValue
			// 
			this.edtFValue.Location = new System.Drawing.Point(68, 110);
			...
			// edtFText
			// 
			this.edtFText.Location = new System.Drawing.Point(68, 135);
			...
			this.cobFProjectID.Location = new System.Drawing.Point(68, 85);
			...
			this.cobFBoatID.Location = new System.Drawing.Point(68, 35);
			this.cobFBoatID.Name = "cobFBoatID";
			this.cobFBoatID.Size = new System.Drawing.Size(272, 20);
			this.cobFBoatID.TabIndex = 38;
			// 
			// cobFDepartID
			// 
			this.cobFDepartID.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cobFDepartID.FormattingEnabled = true;
			this.cobFDepartID.Location = new System.Drawing.Point(68, 60);
			...
			this.splitContainer2.Panel2.Controls.Add(this.cobFBoatIDQ);
			...
			this.dataGridView1.Size = new System.Drawing.Size(645, 574);
			...
			// cobFBoatIDQ
			// 
			this.cobFBoatIDQ.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cobFBoatIDQ.FormattingEnabled = true;
			this.cobFBoatIDQ.Location = new System.Drawing.Point(89, 25);
			this.cobFBoatIDQ.Name = "cobFBoatIDQ";
			this.cobFBoatIDQ.Size = new System.Drawing.Size(272, 20);
			this.cobFBoatIDQ.TabIndex = 38;
			// 
			// label6
			// 
			...
			// Column6
			// 
			this.Column6.DataPropertyName = "FDate";
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "FBoatName";
			this.Column2.HeaderText = "船次";
			this.Column2.Name = "Column2";
			this.Column2.ReadOnly = true;
			// 
			// Column1
			// 
			this.Column1.DataPropertyName = "FDepartName";
			...
			this.Name = "frmYZWaterElecData";
			this.Text = "水电部门自填数据";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.frmYZWaterElecData_Load);
		...
		private System.Windows.Forms.DateTimePicker edtFDate;
		...
		private System.Windows.Forms.ComboBox cobFBoatIDQ;
