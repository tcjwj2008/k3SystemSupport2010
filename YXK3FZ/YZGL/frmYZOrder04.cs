...
{
    public partial class frmYZOrder04 : Form
    {
			...
			/// <param name="sID">内码ID</param>
						public frmYZOrder04(string sMasterState, string sID)
          {
              InitializeComponent();
			...
			private void btnSave_Click(object sender, EventArgs e)
			{
				...
				sSQL = " select * from TAB04 where FClassID='" + cobFClassID.SelectedValue + "' ";
				...
				if (MasterState == "ADD") //新增保存
				{
					...
					SqlParameter[] par = new SqlParameter[] 
                 {
					...
					{
						//获取当前的保存内码
						sSQL = "select ID FROM TAB04 WHERE FClassID=@FClassID and FBoatID=@FBoatID and  FDate=@FDate ";
				...
				{
					sSQL = " update TAB04 set FRunTimeByHour=@FRunTimeByHour	,FDownTimeByHour=@FDownTimeByHour,FAmountOfFinish=@FAmountOfFinish, ";
