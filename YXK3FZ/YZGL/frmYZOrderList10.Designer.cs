...
{
	partial class frmYZOrderList10
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList10));
			...
			this.Column7.HeaderText = "四级油产量(吨)";
			...
			this.Column8.HeaderText = "四级油出库量(吨)";
			...
			this.Column9.HeaderText = "四级油库存量(吨)";
			...
			this.Column2.HeaderText = "毛油库存(吨)";
			...
			this.dataGridViewTextBoxColumn7.HeaderText = "四级油产量(吨)";
			...
			this.dataGridViewTextBoxColumn8.HeaderText = "四级油出库量(吨)";
			...
			this.dataGridViewTextBoxColumn9.HeaderText = "四级油库存量(吨)";
			...
			this.dataGridViewTextBoxColumn10.HeaderText = "毛油库存(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FEmployeeNum";
			this.dataGridViewTextBoxColumn11.HeaderText = "在岗人员(个)";
			...
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "FIllDeviceNum";
			this.dataGridViewTextBoxColumn12.HeaderText = "带病运行设备(台)";
			...
			// 
			this.dataGridViewTextBoxColumn13.DataPropertyName = "FServiceDevice";
			this.dataGridViewTextBoxColumn13.HeaderText = "维修设备(台)";
			...
			this.Name = "frmYZOrderList10";
			this.Tag = "1210";
			this.Text = "生产部--仓储--油库科--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList10_Load);
