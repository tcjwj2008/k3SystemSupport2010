...
{
    public partial class frmYZOrder01 : Form
    {
        ...
        CommonUse commUse = new CommonUse();
			...
			public frmYZOrder01(string sMasterState, string sID)
          {
              InitializeComponent();
          ...
          { 
			  ...
			  private void btnADD_Click(object sender, EventArgs e)
				...
				private void btnSave_Click(object sender, EventArgs e)
				{
					...
					sSQL = " select * from TAB01 where FClassID='" + cobFClassID.SelectedValue + "' ";
						...
						SqlParameter[] par = new SqlParameter[] 
                 {
                     ...
                     new SqlParameter("@FBoatID",cobFBoatID.SelectedValue),
						...
						{	
							//获取当前的保存内码
							sSQL = "select ID FROM TAB01 WHERE FClassID=@FClassID and FBoatID=@FBoatID and  FDate=@FDate ";
							SqlParameter[] par2 = new SqlParameter[] 
                 {
					...
					{
						sSQL = " update TAB01 set FRunTimeByHour=@FRunTimeByHour	,FDownTimeByHour=@FDownTimeByHour,FAmountOfFinish=@FAmountOfFinish	,FConsumptionByTon=@FConsumptionByTon	, ";
