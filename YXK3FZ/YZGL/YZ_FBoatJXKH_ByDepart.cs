...
{
	public partial class YZ_FBoatJXKH_ByDepart : Form
	{
		...
		private void getData()
		{
			...
			try
			{
				DataTable dt01 = k3db.GetDataTable("sp_YZ_JXKHSelectByDept_czq", inputParameters2);
