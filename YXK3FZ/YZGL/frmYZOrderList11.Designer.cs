...
{
	partial class frmYZOrderList11
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList11));
			...
			this.cmsRight.Size = new System.Drawing.Size(153, 48);
			// 
			// 查看ToolStripMenuItem
			// 
			...
			this.Column8.HeaderText = "编织袋-耗量(万条)";
			...
			// Column9
			// 
			this.Column9.DataPropertyName = "FOilStoreByTon";
			this.Column9.HeaderText = "编织袋-单耗(条/吨)";
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "FMOilStoreByTon";
			this.Column2.HeaderText = "粕出库量(吨)";
			...
			// Column20
			// 
			this.Column20.DataPropertyName = "FNum1";
			this.Column20.HeaderText = "粕库存量-1#(吨)";
			...
			// Column21
			// 
			this.Column21.DataPropertyName = "FNum2";
			this.Column21.HeaderText = "粕库存量-2#(吨)";
			...
			this.dataGridViewTextBoxColumn7.HeaderText = "粕产量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn8.DataPropertyName = "FConsumptionByTon";
			this.dataGridViewTextBoxColumn8.HeaderText = "编织袋-耗量(万条)";
			...
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "FOilStoreByTon";
			this.dataGridViewTextBoxColumn9.HeaderText = "编织袋-单耗(条/吨)";
			...
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "FMOilStoreByTon";
			this.dataGridViewTextBoxColumn10.HeaderText = "粕出库量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FNum1";
			this.dataGridViewTextBoxColumn11.HeaderText = "粕库存量-1#(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "FNum2";
			this.dataGridViewTextBoxColumn12.HeaderText = "粕库存量-2#(吨)";
			...
			this.Name = "frmYZOrderList11";
			this.Tag = "1211";
			this.Text = "生产部--仓储--粕库科--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList11_Load);
