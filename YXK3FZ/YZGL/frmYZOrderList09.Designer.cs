...
{
	partial class frmYZOrderList09
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList09));
			...
			this.Column8.HeaderText = "油料入库量(吨)";
			...
			this.Column9.HeaderText = "油料库存量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn2.DataPropertyName = "FBoatName";
			this.dataGridViewTextBoxColumn2.HeaderText = "船";
			...
			this.dataGridViewTextBoxColumn8.HeaderText = "油料入库量(吨)";
			...
			this.dataGridViewTextBoxColumn9.HeaderText = "油料库存量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "FEmployeeNum";
			this.dataGridViewTextBoxColumn10.HeaderText = "在岗人员(个)";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FIllDeviceNum";
			this.dataGridViewTextBoxColumn11.HeaderText = "带病运行设备(台)";
			...
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "FServiceDevice";
			this.dataGridViewTextBoxColumn12.HeaderText = "维修设备(台)";
			...
			this.Name = "frmYZOrderList09";
			this.Tag = "1209";
			this.Text = "生产部--仓储--筒仓科--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList09_Load);
