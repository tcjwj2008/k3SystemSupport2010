...
{
	partial class frmYZOrderList01
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList01));
			...
			this.Column8.HeaderText = "溶剂耗量(吨)";
			...
			this.Column9.HeaderText = "单耗(公斤/吨料)";
			...
			this.dataGridViewTextBoxColumn8.HeaderText = "溶剂耗量(吨)";
			this.dataGridViewTextBoxColumn8.Name = "dataGridViewTextBoxColumn8";
			this.dataGridViewTextBoxColumn8.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn9
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "FPerConsumption";
			this.dataGridViewTextBoxColumn9.HeaderText = "单耗(公斤/吨料)";
			...
			this.Name = "frmYZOrderList01";
			this.Tag = "1201";
			this.Text = "生产部--车间--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList01_Load);
