namespace YXK3FZ.YZGL
{
	partial class YZ_FYearData
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(YZ_FYearData));
			...
			this.edtCB = new System.Windows.Forms.TextBox();
			...
			this.splitContainer1.Panel1.Controls.Add(this.edtCB);
			...
			// edtCB
			// 
			this.edtCB.Location = new System.Drawing.Point(81, 80);
			this.edtCB.Name = "edtCB";
			this.edtCB.Size = new System.Drawing.Size(208, 21);
			this.edtCB.TabIndex = 38;
			// 
			// edtFText
			// 
			this.edtFText.Location = new System.Drawing.Point(81, 105);
			...
			this.dataGridView1.Size = new System.Drawing.Size(694, 527);
			...
			// Column4
			// 
			this.Column4.DataPropertyName = "成本";
			this.Column4.HeaderText = "成本";
			...
			this.Name = "YZ_FYearData";
			this.Text = "年度绩效考核成本指标数据(按分项)";
			this.WindowState = System.Windows.Forms.FormWindowState.Maximized;
			this.Load += new System.EventHandler(this.YZ_FYearData_Load);
		...
		private System.Windows.Forms.TextBox edtCB;
