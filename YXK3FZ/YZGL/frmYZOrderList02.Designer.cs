...
{
	partial class frmYZOrderList02
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList02));
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "FAmountOfFinish2";
			this.Column2.HeaderText = "蒸汽量(吨)";
			this.Column2.Name = "Column2";
			this.Column2.ReadOnly = true;
			// 
			// Column8
			// 
			this.Column8.DataPropertyName = "FConsumptionByTon";
			this.Column8.HeaderText = "煤耗-耗量(吨)";
			...
			// Column9
			// 
			this.Column9.DataPropertyName = "FPerConsumption";
			this.Column9.HeaderText = "煤耗-单耗(公斤/吨料)";
			...
			// Column20
			// 
			this.Column20.DataPropertyName = "FConsumptionByTon2";
			this.Column20.HeaderText = "蒸汽耗-耗量(吨)";
			...
			// Column21
			// 
			this.Column21.DataPropertyName = "FPerConsumption2";
			this.Column21.HeaderText = "蒸汽耗-单耗(公斤/吨料)";
			...
			// Column11
			// 
			this.Column11.DataPropertyName = "FIllDeviceNum";
			this.Column11.HeaderText = "带病运行设备(台)";
			...
			// Column12
			// 
			this.Column12.DataPropertyName = "FServiceDevice";
			this.Column12.HeaderText = "维修设备(台)";
			...
			// 
			this.dataGridViewTextBoxColumn8.DataPropertyName = "FAmountOfFinish2";
			this.dataGridViewTextBoxColumn8.HeaderText = "蒸汽量(吨)";
			this.dataGridViewTextBoxColumn8.Name = "dataGridViewTextBoxColumn8";
			this.dataGridViewTextBoxColumn8.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn9
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "FConsumptionByTon";
			this.dataGridViewTextBoxColumn9.HeaderText = "煤耗-耗量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "FPerConsumption";
			this.dataGridViewTextBoxColumn10.HeaderText = "煤耗-单耗(公斤/吨料)";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FConsumptionByTon2";
			this.dataGridViewTextBoxColumn11.HeaderText = "蒸汽耗-耗量(吨)";
			...
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "FPerConsumption2";
			this.dataGridViewTextBoxColumn12.HeaderText = "蒸汽耗-单耗(公斤/吨料)";
			...
			// 
			this.dataGridViewTextBoxColumn13.DataPropertyName = "FEmployeeNum";
			this.dataGridViewTextBoxColumn13.HeaderText = "在岗人员(个)";
			...
			// 
			this.dataGridViewTextBoxColumn14.DataPropertyName = "FIllDeviceNum";
			this.dataGridViewTextBoxColumn14.HeaderText = "带病运行设备(台)";
			...
			// 
			this.dataGridViewTextBoxColumn15.DataPropertyName = "FServiceDevice";
			this.dataGridViewTextBoxColumn15.HeaderText = "维修设备(台)";
			...
			this.Name = "frmYZOrderList02";
			this.Tag = "1202";
			this.Text = "生产部--锅炉科--锅炉车间--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList02_Load);
