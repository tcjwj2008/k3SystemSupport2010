...
{
	partial class frmYZOrderList12
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList12));
			...
			// Column2
			// 
			this.Column2.DataPropertyName = "FField01";
			this.Column2.HeaderText = "粕产量(吨)";
			this.Column2.Name = "Column2";
			this.Column2.ReadOnly = true;
			// 
			// Column4
			// 
			this.Column4.DataPropertyName = "FField02";
			this.Column4.HeaderText = "考核水分(%)";
			...
			// Column5
			// 
			this.Column5.DataPropertyName = "FField03";
			this.Column5.HeaderText = "平均水分(%)";
			this.Column5.Name = "Column5";
			this.Column5.ReadOnly = true;
			// 
			// Column6
			// 
			this.Column6.DataPropertyName = "FField04";
			this.Column6.HeaderText = "合格率(%)";
			this.Column6.Name = "Column6";
			this.Column6.ReadOnly = true;
			// 
			// Column7
			// 
			this.Column7.DataPropertyName = "FField05";
			this.Column7.HeaderText = "湿粕-平均残油(%)";
			...
			// Column8
			// 
			this.Column8.DataPropertyName = "FField06";
			this.Column8.HeaderText = "湿粕残油-合格率(%)";
			...
			// Column9
			// 
			this.Column9.DataPropertyName = "FField07";
			this.Column9.HeaderText = "粕残油-平均残油(%)";
			...
			// Column10
			// 
			this.Column10.DataPropertyName = "FField08";
			this.Column10.HeaderText = "粕残油-合格率(%)";
			...
			// Column11
			// 
			this.Column11.DataPropertyName = "FField09";
			this.Column11.HeaderText = "粕粗-平均粗蛋白(%)";
			...
			// Column12
			// 
			this.Column12.DataPropertyName = "FField10";
			this.Column12.HeaderText = "粕粗蛋白-合格率(%)";
			...
			// Column20
			// 
			this.Column20.DataPropertyName = "FField11";
			this.Column20.HeaderText = "加热试验-合格率(%)";
			...
			// Column21
			// 
			this.Column21.DataPropertyName = "FField12";
			this.Column21.HeaderText = "平均蓝色增加值";
			...
			// Column22
			// 
			this.Column22.DataPropertyName = "FField13";
			this.Column22.HeaderText = "蓝色值-合格率(%)";
			...
			// 
			this.dataGridViewTextBoxColumn4.DataPropertyName = "FField01";
			this.dataGridViewTextBoxColumn4.HeaderText = "粕产量(吨)";
			this.dataGridViewTextBoxColumn4.Name = "dataGridViewTextBoxColumn4";
			this.dataGridViewTextBoxColumn4.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn5
			// 
			this.dataGridViewTextBoxColumn5.DataPropertyName = "FField02";
			this.dataGridViewTextBoxColumn5.HeaderText = "考核水分(%)";
			...
			// 
			this.dataGridViewTextBoxColumn6.DataPropertyName = "FField03";
			this.dataGridViewTextBoxColumn6.HeaderText = "平均水分(%)";
			this.dataGridViewTextBoxColumn6.Name = "dataGridViewTextBoxColumn6";
			this.dataGridViewTextBoxColumn6.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn7
			// 
			this.dataGridViewTextBoxColumn7.DataPropertyName = "FField04";
			this.dataGridViewTextBoxColumn7.HeaderText = "合格率(%)";
			this.dataGridViewTextBoxColumn7.Name = "dataGridViewTextBoxColumn7";
			this.dataGridViewTextBoxColumn7.ReadOnly = true;
			// 
			// dataGridViewTextBoxColumn8
			// 
			this.dataGridViewTextBoxColumn8.DataPropertyName = "FField05";
			this.dataGridViewTextBoxColumn8.HeaderText = "湿粕-平均残油(%)";
			...
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "FField06";
			this.dataGridViewTextBoxColumn9.HeaderText = "湿粕残油-合格率(%)";
			...
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "FField07";
			this.dataGridViewTextBoxColumn10.HeaderText = "粕残油-平均残油(%)";
			...
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "FField08";
			this.dataGridViewTextBoxColumn11.HeaderText = "粕残油-合格率(%)";
			...
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "FField09";
			this.dataGridViewTextBoxColumn12.HeaderText = "粕粗-平均粗蛋白(%)";
			...
			// 
			this.dataGridViewTextBoxColumn13.DataPropertyName = "FField10";
			this.dataGridViewTextBoxColumn13.HeaderText = "粕粗蛋白-合格率(%)";
			...
			// 
			this.dataGridViewTextBoxColumn14.DataPropertyName = "FField11";
			this.dataGridViewTextBoxColumn14.HeaderText = "加热试验-合格率(%)";
			...
			// 
			this.dataGridViewTextBoxColumn15.DataPropertyName = "FField12";
			this.dataGridViewTextBoxColumn15.HeaderText = "平均蓝色增加值";
			...
			// 
			this.dataGridViewTextBoxColumn16.DataPropertyName = "FField13";
			this.dataGridViewTextBoxColumn16.HeaderText = "蓝色值-合格率(%)";
			...
			this.Name = "frmYZOrderList12";
			this.Tag = "1212";
			this.Text = "品管部--质量--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList12_Load);
