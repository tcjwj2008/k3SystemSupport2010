...
{
	partial class frmYZOrderList03
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmYZOrderList03));
			...
			this.Column7.HeaderText = "SO2排放合格率(%)";
			...
			this.Column8.HeaderText = "烟尘排放合格率(%)";
			...
			this.dataGridViewTextBoxColumn7.HeaderText = "SO2排放合格率(%)";
			...
			this.dataGridViewTextBoxColumn8.HeaderText = "烟尘排放合格率(%)";
			...
			this.Name = "frmYZOrderList03";
			this.Tag = "1203";
			this.Text = "生产部--锅炉科--环保--加工日历序时簿";
			this.Load += new System.EventHandler(this.frmYZOrderList03_Load);
