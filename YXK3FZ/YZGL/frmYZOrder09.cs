...
{
    public partial class frmYZOrder09 : Form
    {
			...
			/// <param name="sID">内码ID</param>
						public frmYZOrder09(string sMasterState, string sID)
          {
              InitializeComponent();
			...
			private void btnSave_Click(object sender, EventArgs e)
			{
				...
				sSQL = " select * from TAB09 where FClassID='" + cobFClassID.SelectedValue + "' ";
				...
				{
					sSQL = " INSERT INTO TAB09 ";
					sSQL += " ( ";
					sSQL += " FClassID, FBoatID ,FOrderClass,FDate,FRunTimeByHour	,FDownTimeByHour,FAmountOfFinish	,FConsumptionByTon	,FOilStoreByTon, ";
					...
					SqlParameter[] par = new SqlParameter[] 
                 {
					...
					{
						//获取当前的保存内码
						sSQL = "select ID FROM TAB09 WHERE FClassID=@FClassID and FBoatID=@FBoatID and  FDate=@FDate ";
				...
				{
					sSQL = " update TAB09 set FRunTimeByHour=@FRunTimeByHour	,FDownTimeByHour=@FDownTimeByHour,FAmountOfFinish=@FAmountOfFinish	,FConsumptionByTon=@FConsumptionByTon	,FOilStoreByTon=@FOilStoreByTon, ";
